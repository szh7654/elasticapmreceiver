...
func (r *elasticapmReceiver) registerTraceConsumer(nextConsumer consumer.Traces) error {
	if nextConsumer == nil {
		return errors.New("next consumer is nil")
	}
...
func (r *elasticapmReceiver) handleEvents(w http.ResponseWriter, req *http.Request) {
	traceData, _ := r.handleTraces(w, req, &modelpb.APMEvent{})
	if traceData != nil {
...
func (r *elasticapmReceiver) handleRUMEvents(w http.ResponseWriter, req *http.Request) {
	...
	traceData, _ := r.handleTraces(w, req, baseEvent)
	if traceData != nil {
		r.nextConsumer.ConsumeTraces(req.Context(), *traceData)
	}
}
...
func (r *elasticapmReceiver) handleTraces(w http.ResponseWriter, req *http.Request, baseEvent *modelpb.APMEvent) (*ptrace.Traces, error) {
